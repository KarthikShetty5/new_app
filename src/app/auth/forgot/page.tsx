...
const Forgot: React.FC = () => {
    ...
    const Forgot = async (e: any) => {
        ...
        try {
            ...
            toast.success('Email sent successfully!', { //this is react-toastify which is used to show up notification
                position: "top-left",
                autoClose: 1500,
    ...
    return (
        <>
            <ToastContainer
                ...
                pauseOnHover
            />
            <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark max-h-fit">
